...
@st.cache_resource    
def load_model():
    with open(r"C:\Users\mariy\Desktop\RE\ml project\saved_models\RandomForestRegressor.pkl", 'rb') as f:
        model = pickle.load(f)

    with open(r"C:\Users\mariy\Desktop\RE\ml project\saved_scaling\scaler.pkl", 'rb') as f:
